# X Media Gallery — Download Photos & Videos
...
2. Click the X Media Gallery toolbar icon to enter gallery view
...
X Media Gallery is free, open source, and ad-free. If it's been useful, you can support development:
